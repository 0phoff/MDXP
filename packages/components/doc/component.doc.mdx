...
import {AutoStepper, Block, Flex, Grid, Head, Place, Styling} from '../src/component'
...
## Head
This extraction type component allows you to set metadata of your presentation inside of your MDX file.
