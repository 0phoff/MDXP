...
You can use this as a source of inspiration or even to learn how to use MDXP to create beautiful slide decks.
...
This is the main MDXP Demo.

Do note that it is build to be a bit more mobile-friendly than your average presentations, which in turn might make some things a bit more complicated (mainly theming-wise).
