...
### Examples
```mdxp
<ThemeWrapper newTheme={{colors: {background: 'tomato'}}}>
...
> __NOTE__  
> In order to use this wrapper, you need to explicitely import the Layout you want to use it with
> and can't rely on the _components_ property of your `Deck`.
...
### Examples
```md
<!-- Note that we cannot show this example in action, as the MDX runtime does not allow imports -->
